...
create policy "email intake storage read"
...
create policy "email intake storage insert"
...
with check (
  ...
  and lower(storage.extension(storage.objects.name)) in ('pdf','png','jpg','jpeg','xls','xlsx','csv')
);

create policy "email intake storage delete"
